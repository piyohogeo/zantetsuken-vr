...
| T-044 | MobPlan再現性 | 同じ入力、Seed、NavMesh、PlanGenerationから同じ計画区間を生成できる | 固定シーンの計画Hash、経路、Animation位相、RootTrajectoryを比較 |

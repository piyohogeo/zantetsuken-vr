...
$project="$private/Working/D6T-cdb53ea/Project"
$output="$product/Logs/CharacterRequestMigration/$RunName"
...
$sources=@('Runtime/PhysicsCut/CutWorldRoot.cs',
...
$filter=if($RunName.StartsWith('full')){''}elseif($RunName.StartsWith('related')){' -testFilter Zantetsu.PhysicsCut.PlayModeTests.ProvisionalMassFlagActivationPlayModeTests'}else{' -testFilter D6T_'}

...
{
    /// <summary>
    /// A non-owning, allocation-free reservation of one fixed Frame Work Slot
    /// in a <see cref="NvencCaptureWorkSlotPool"/>. This logical lease carries
    /// only the issuing pool correlation, slot index, and generation; it holds
    /// no Texture, NVENC handle, Completion Event, or other native resource.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    internal readonly struct NvencCaptureWorkSlotLease
    {
        private readonly Guid _ownerToken;
        private readonly int _slotIndex;
        private readonly long _generation;

        internal NvencCaptureWorkSlotLease(Guid ownerToken, int slotIndex, long generation)
        {

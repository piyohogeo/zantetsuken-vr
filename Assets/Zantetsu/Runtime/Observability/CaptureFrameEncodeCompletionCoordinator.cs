...
namespace Zantetsu.Observability
{
    ...
    /// </remarks>
    internal sealed class CaptureFrameEncodeCompletionCoordinator
    {
        private readonly ICaptureFrameEncodeService _service;
        private readonly CaptureFrameTraceObserver _observer;
        private readonly long[] _lastAppliedGenerations;

        internal CaptureFrameEncodeCompletionCoordinator(
            ICaptureFrameEncodeService service,
        ...
        internal CaptureFrameEncodeApplyResult Apply(in CaptureFrameEncodeCompletion completion)
        {
            ...
            try
            {
                ...
                {
                    case CaptureFrameEncodeCompletionStatus.Succeeded:
                        ...
                        CaptureFrameEncodeApplyResult result = new CaptureFrameEncodeApplyResult(

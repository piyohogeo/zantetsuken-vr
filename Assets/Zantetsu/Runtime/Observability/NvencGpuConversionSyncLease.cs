...
{
    /// <summary>
    /// A non-owning, allocation-free reservation of one fixed GPU Conversion
    /// Sync credit in a <see cref="NvencGpuConversionSyncPool"/>. This logical
    /// lease carries only the issuing pool correlation, slot index, and
    /// generation; it holds no GraphicsFence, ComputeBuffer, AsyncGPUReadback
    /// request, CommandBuffer, Query, Texture, or other native resource.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    internal readonly struct NvencGpuConversionSyncLease
    {
        private readonly Guid _ownerToken;
        private readonly int _slotIndex;
        private readonly long _generation;

        internal NvencGpuConversionSyncLease(Guid ownerToken, int slotIndex, long generation)
        {

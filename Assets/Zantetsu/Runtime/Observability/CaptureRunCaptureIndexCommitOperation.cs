...
namespace Zantetsu.Observability
{
    ...
    internal sealed class CaptureRunCaptureIndexCommitOperation
    {
        ...
        /// authoritative plan. <see cref="Acquire"/> performs the single
        /// canonical serialization and binds the plan to the generated byte
        /// array by reference identity, so no caller can mint a token for an
        ...
        internal sealed class CanonicalBytesToken
        {
            ...
            internal static CanonicalBytesToken Acquire(CapturePublicationPlan plan, out byte[] canonicalBytes)
            {
                if (plan == null)
                {
                ...
                canonicalBytes = CapturePublicationPlanCodec.SerializeCanonical(plan);

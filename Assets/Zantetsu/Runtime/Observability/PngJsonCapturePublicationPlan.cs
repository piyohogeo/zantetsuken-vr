...
namespace Zantetsu.Observability
{
    ...
    /// </para>
    /// </remarks>
    internal sealed class PngJsonCapturePublicationPlan
    {
        ...
        internal PngJsonCapturePublicationPlan(
            long testRunId,
            ...
            PngJsonCapturePublicationPlanEntry[] entries)
        {
            ...
            {
                PngJsonCapturePublicationPlanEntry entry = entries[i];
                if (entry == null)
                {
            ...
            PngJsonCapturePublicationPlanEntry[] copy = new PngJsonCapturePublicationPlanEntry[entries.Length];
        ...
        /// </summary>
        internal PngJsonCapturePublicationPlanEntry GetEntry(int index)
        {
        ...
        internal bool IsValid
        {
            get
            {
                ...
                {
                    PngJsonCapturePublicationPlanEntry entry = _entries[i];

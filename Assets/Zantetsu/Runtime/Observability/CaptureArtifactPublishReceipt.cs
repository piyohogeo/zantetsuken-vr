...
{
    internal sealed class CaptureArtifactPublishReceipt : ICaptureArtifactStorageReceipt
    {
        internal CaptureArtifactPublishReceipt(ICaptureArtifactStore issuedBy, CaptureArtifactDescriptor descriptor, string absolutePath)
        {

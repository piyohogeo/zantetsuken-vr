...
{
    /// <summary>
    /// Canonical UTF-8 JSON serializer for <see cref="PngJsonCapturePublicationPlan"/>.
    ...
    /// </remarks>
    internal static class PngJsonCapturePublicationPlanCodec
    {
        ...
        internal static byte[] SerializeCanonical(PngJsonCapturePublicationPlan plan)
        {
            if (plan == null)
            {
        ...
        /// </summary>
        internal static PngJsonCapturePublicationPlan DeserializeCanonical(
            byte[] utf8Json,
            int maxPlanBytes,
            int maxEntryCount,
            int maxPathBytes)
        ...
        private static PngJsonCapturePublicationPlan Decode(byte[] document, int maxEntryCount, int maxPathBytes)
        {
            ...
            try
            {
                plan = new PngJsonCapturePublicationPlan(testRunId, runInitializationId, runManifestContentSha256, entries);
            }
        ...
        private static PngJsonCapturePublicationPlanEntry DecodeEntry(CanonicalReader reader, int maxPathBytes)
        {
            reader.Expect((byte)'{');
        ...
        private static void AppendEntry(StringBuilder sb, PngJsonCapturePublicationPlanEntry entry)
        {

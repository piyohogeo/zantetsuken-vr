...
namespace Zantetsu.Observability
{
    ...
    /// </para>
    /// </remarks>
    internal interface IPngJsonCaptureFrameEncodeService : IDisposable
    {
        int Capacity { get; }

        Guid OwnerToken { get; }

        PngJsonCaptureFrameEncodeSubmitStatus TrySubmit(
            PngJsonCaptureFrameEncodeSubmission submission,
            out CaptureFrameWorkToken workToken);

        bool TryCollect(out PngJsonCaptureFrameEncodeCompletion completion);

...
{
    /// <summary>
    /// A non-owning, allocation-free write reservation of the single fixed
    ...
    /// </remarks>
    internal readonly struct NvencAccessUnitWriteLease
    {
        private readonly Guid _ownerToken;
        private readonly long _generation;
        private readonly CaptureFrameWorkToken _workToken;

        internal NvencAccessUnitWriteLease(Guid ownerToken, long generation, in CaptureFrameWorkToken workToken)
        {

namespace Zantetsu.Observability
{
    ...
    /// plan read or write, and no disposition update. Phase 0.11 leaves a
    /// failed publication exactly as it found it and hands the Run to
    /// <c>PublicationRecoveryRequired</c>.
    /// </para>
    /// <para>

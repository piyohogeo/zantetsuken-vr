...
namespace Zantetsu.Observability
{
    ...
    /// </remarks>
    internal sealed class PngJsonSynchronousCaptureFrameEncodeService : IPngJsonCaptureFrameEncodeService
    {
        ...
        internal PngJsonSynchronousCaptureFrameEncodeService(int capacity)
        {
            if (capacity <= 0)
            {
        ...
        private void EnsureConstructingThread()
        {
            ...
            if (_disposed)
            {
                throw new ObjectDisposedException(nameof(PngJsonSynchronousCaptureFrameEncodeService));
            }
        }
    }
}

...
{
    /// <summary>
    /// A non-owning, allocation-free reservation of one fixed Frame Completion
    /// capacity credit in a <see cref="NvencFrameCompletionCreditPool"/>. It
    ...
    /// </remarks>
    internal readonly struct NvencFrameCompletionCreditLease
    {
        private readonly Guid _ownerToken;
        private readonly int _slotIndex;
        private readonly long _generation;

        internal NvencFrameCompletionCreditLease(Guid ownerToken, int slotIndex, long generation)
        {

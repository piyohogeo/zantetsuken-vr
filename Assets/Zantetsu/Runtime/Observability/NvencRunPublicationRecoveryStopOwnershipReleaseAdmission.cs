...
{
    /// <summary>
    /// The single place that decides whether one stopping publication recovery
    ...
    /// inadmissible are refused. The collision and deferred stopping shapes are
    /// not distinguished here - both stopped without changing a file - and no
    /// retry counter, attempt latch, or partial-release status is introduced.
    /// This type holds no state, reads no process state, and changes nothing.
    /// </remarks>
    internal static class NvencRunPublicationRecoveryStopOwnershipReleaseAdmission
    {
        /// <summary>

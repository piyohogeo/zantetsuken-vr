...
namespace Zantetsu.Core.Tests
{
    ...
    public class NvencRunCaptureCompleteCleanupExecutionCoordinatorContractTests
    {
        ...
        [Test]
        public void Result_ForwardsOperationGraph_ReceiptHoldsCleanerAndOperation()
        {
            using (Harness h = Harness.Create())
            {
                NvencRunCaptureCompleteCleanupOperation operation = PrepareCleanup(h);
                ...
                // The receipt holds only the exact cleaner and the exact
                ...
                Assert.That(receipt.Cleaner, Is.SameAs(cleaner));

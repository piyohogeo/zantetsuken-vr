...
{
    public class PngJsonCapturePublicationPlanDeserializeTests
    {
        ...
        private static Type GetEntryType() => GetTypeFromAssembly("PngJsonCapturePublicationPlanEntry");

        private static Type GetPlanType() => GetTypeFromAssembly("PngJsonCapturePublicationPlan");

        private static Type GetCodecType() => GetTypeFromAssembly("PngJsonCapturePublicationPlanCodec");
        ...
        {
            string source = File.ReadAllText(LocateSource("Assets/Zantetsu/Runtime/Observability/PngJsonCapturePublicationPlanCodec.cs"));
        ...
        private static string LocateSource(string relativePath)
        {
            ...
            string dir = Path.GetDirectoryName(typeof(PngJsonCapturePublicationPlanDeserializeTests).Assembly.Location);
            while (dir != null)
            {
